...
#include "Volume_ControlBPLibrary.generated.h"
...
*/
UCLASS()
class UVolume_ControlBPLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_UCLASS_BODY()
public:
	UFUNCTION(BlueprintPure, meta = (DisplayName = "Get Master Volume ", Keywords = "Get Master Volume "), Category = "Volume Controller")
		static float GetMasterVolume();
	UFUNCTION(BlueprintPure, meta = (DisplayName = "Get Effect Volume ", Keywords = "Get Effect Volume "), Category = "Volume Controller")
